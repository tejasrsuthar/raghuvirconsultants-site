# Enterprise System Architecture (v2.12.2)
...
graph TD
    ...
    subgraph ComposeStack["Unified Docker Compose Stack (Default Bridge Network)"]
        ...
        subgraph FastAPIServer["FastAPI Asynchronous Backend (v2.12.2)"]
