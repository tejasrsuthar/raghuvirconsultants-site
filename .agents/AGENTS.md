...
- **Graphify Graph**: Update the graphify graph and architectural dependency representations with every update by executing: `graphify extract . --code-only && graphify cluster-only /Users/harshitsuthar/workspace/stock-analytics/`
